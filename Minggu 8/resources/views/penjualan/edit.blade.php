...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('penjualan/' . $penjualan->penjualan_id . '/update') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    <select class="form-control" id="user_id" name="user_id" required>
                        ...
                        <option value="{{ $item->user_id }}" {{ $item->user_id == $penjualan->user_id ? 'selected' : '' }}>
                            {{ $item->nama }}
                        </option>
                        @endforeach
                    </select>
